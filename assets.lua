Sprites = {
	...
	heroes = {
		auCo = love.graphics.newImage('assets/heroes/Au Co.png'),
		sonTinh = love.graphics.newImage('assets/heroes/Son Tinh.png'),
		thuyTinh = love.graphics.newImage('assets/heroes/Thuy Tinh.png'),
		hungVuong = love.graphics.newImage('assets/heroes/Hung Vuong.png'),
	}
}
